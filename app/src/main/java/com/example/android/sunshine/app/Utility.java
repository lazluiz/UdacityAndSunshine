    ...
    static class Format {
        static String formatTemperature(Context context, double temperature, boolean isMetric) {
            ...
            if (!isMetric) {
                ...
                type = context.getString(R.string.fahrenheit);
            } else {
                temp = temperature;
        ...
        public static String getFormattedMonthDay(Context context, long dateInMillis) {
            Time time = new Time();
            time.setToNow();
            SimpleDateFormat dbDateFormat = new SimpleDateFormat(Utility.Format.DATE_FORMAT);
        ...
        public static String getFormattedWind(Context context, float windSpeed, float degrees) {
            int windFormat;
            if (Utility.Settings.isMetric(context)) {
