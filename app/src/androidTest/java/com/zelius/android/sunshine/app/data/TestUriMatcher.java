...
public class TestUriMatcher extends AndroidTestCase {
    ...
    public void testUriMatcher() {
        ...
        assertEquals("Error: The WEATHER URI was matched incorrectly.", WeatherProvider.WEATHER,
                testMatcher.match(TEST_WEATHER_DIR));
        assertEquals("Error: The WEATHER WITH LOCATION URI was matched incorrectly.", WeatherProvider.WEATHER_WITH_LOCATION,
                testMatcher.match(TEST_WEATHER_WITH_LOCATION_DIR));
        assertEquals("Error: The WEATHER WITH LOCATION AND DATE URI was matched incorrectly.", WeatherProvider.WEATHER_WITH_LOCATION_AND_DATE,
                testMatcher.match(TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR));
        assertEquals("Error: The LOCATION URI was matched incorrectly.", WeatherProvider.LOCATION,
